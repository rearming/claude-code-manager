...
>(({ className, withCloseButton = true, children, ...props }, ref) => (
  <DialogPortal>
    {/* Wrapper with data-floating-ignore-outside to prevent FloatingWindow from closing on dialog interactions */}
    <div data-floating-ignore-outside className="contents">
      <DialogOverlay />
